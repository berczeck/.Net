...
// 
//     Configuration file:     "EfReversePocoGenerator\App.config"
//     Connection String Name: "MyDbContext"
//     Connection String:      "Data Source=ALEX-HP;Initial Catalog=Northwind;Integrated Security=True;Application Name=MyApp"
...
namespace EfReversePocoGenerator
{
    // ************************************************************************
    // Unit of work
    public interface IMyDbContext : IDisposable
    {
        ...
        IDbSet<Fraude> Fraudes { get; set; } // fraude
        IDbSet<Invoice> Invoices { get; set; } // Invoices
        IDbSet<IsolationTest> IsolationTests { get; set; } // IsolationTests
    ...
    public class MyDbContext : DbContext, IMyDbContext
    {
        ...
        public IDbSet<Fraude> Fraudes { get; set; } // fraude
        public IDbSet<Invoice> Invoices { get; set; } // Invoices
        public IDbSet<IsolationTest> IsolationTests { get; set; } // IsolationTests
        ...
        protected override void OnModelCreating(DbModelBuilder modelBuilder)
        {
            ...
            modelBuilder.Configurations.Add(new FraudeConfiguration());
            modelBuilder.Configurations.Add(new InvoiceConfiguration());
            modelBuilder.Configurations.Add(new IsolationTestConfiguration());
        ...
        public static DbModelBuilder CreateModel(DbModelBuilder modelBuilder, string schema)
        {
            ...
            modelBuilder.Configurations.Add(new FraudeConfiguration(schema));
            modelBuilder.Configurations.Add(new InvoiceConfiguration(schema));
            modelBuilder.Configurations.Add(new IsolationTestConfiguration(schema));
    ...
    public class Fraude
    {
        ...
        public byte[] Tocken { get; internal set; } // tocken
    }
    ...
    // fraude
    internal class FraudeConfiguration : EntityTypeConfiguration<Fraude>
    {
        public FraudeConfiguration(string schema = "dbo")
        {
            ToTable(schema + ".fraude");
            HasKey(x => new { x.Id, x.Tocken });

            Property(x => x.Id).HasColumnName("id").IsRequired().HasDatabaseGeneratedOption(DatabaseGeneratedOption.Identity);
            Property(x => x.Fecha).HasColumnName("fecha").IsOptional();
            Property(x => x.Tocken).HasColumnName("tocken").IsRequired().HasMaxLength(8).IsFixedLength().IsRowVersion();
        }
    }
    ...
    // IsolationTests
    internal class IsolationTestConfiguration : EntityTypeConfiguration<IsolationTest>
    {
        public IsolationTestConfiguration(string schema = "dbo")
        {
            ToTable(schema + ".IsolationTests");
            HasKey(x => x.Id);

            Property(x => x.Id).HasColumnName("Id").IsRequired().HasDatabaseGeneratedOption(DatabaseGeneratedOption.Identity);
            Property(x => x.Col1).HasColumnName("Col1").IsOptional();
            Property(x => x.Col2).HasColumnName("Col2").IsOptional();
            Property(x => x.Col3).HasColumnName("Col3").IsOptional();
        }
    }
